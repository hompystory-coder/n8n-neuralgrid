...
6. **🎯 히트곡 제목 법칙 - 후렴구 핵심 프레이즈 반복 (필수!)**:
   ...
   - 그 핵심 구절을 **매 Chorus마다 똑같이 3번 이상 반복**하세요
   - 예시 (한국어): "그대로 아름다워" 반복, "함께 걸어가면" 반복, "빛나고 있어" 반복
   - 예시 (영어): "We'll shine together" 반복, "Dancing in the light" 반복, "Never let you go" 반복
   - **이 반복 구절이 곡 제목이 됩니다!** (아델 "Rolling in the Deep", 콜드플레이 "Fix You" 방식)
7. 감정이 풍부하고 독창적인 스토리
