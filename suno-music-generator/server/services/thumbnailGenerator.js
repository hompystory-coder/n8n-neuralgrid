...
`;
  ...
  return `Professional YouTube music playlist thumbnail - Character-Focused Design (Highest CTR style)

MAIN SUBJECT (MOST IMPORTANT - 60% of composition):
${template.visualElements.split(',')[0]}
- Style: Anime/illustrated character (${template.referenceStyle})
- Expression: ${template.mood.split(',')[0]} - peaceful, relatable face
...
`;
  ...
  return `Professional YouTube music playlist thumbnail - Mood-Landscape Design (Cinematic style)
